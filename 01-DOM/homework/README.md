...
-  DOM = El DOM es una representacion en memoria de la estrutura de un docuemento en HTML en forma de arbol, permite por ejemplo a un lenguaje como JavaScript acceder, manipular y modificar elementos y continido de una pagina web para hacerla mas dinamica.
-  DOM element selectors: Los selectores permiten que JavaScript se comunique con el HTML y estos seleccionan etiquetas, id y clases. Pero en JavaScript se usa mas los id para ser mas especifico.
-  DOM events: Los eventos permiten hacer que se realice una accion como por ej el evento 'click' permite que al dar click ocurra una accion.
